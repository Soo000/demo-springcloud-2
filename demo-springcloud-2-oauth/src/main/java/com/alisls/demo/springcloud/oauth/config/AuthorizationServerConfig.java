package com.alisls.demo.springcloud.oauth.config;
...
import com.alisls.demo.springcloud.oauth.service.impl.RandomAuthenticationKeyGenerator;
import com.alisls.demo.springcloud.oauth.service.impl.RedisAuthorizationCodeServices;
import com.alisls.demo.springcloud.oauth.service.impl.RedisClientDetailsService;
...
//    private BCryptPasswordEncoder bCryptPasswordEncoder;
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		/*
		clients.inMemory()
			.withClient("system").secret(bCryptPasswordEncoder.encode("system"))
