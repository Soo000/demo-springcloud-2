package com.demo.springcloud.common.core.crypto;
...
public class SM2Utils {
    ...
    public static String decrypt(String password) throws Exception {
        ...
        String plainText = new String(SM2Utils.decrypt(Util.hexToByte(prik), Util.hexToByte(password)));
        return plainText;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // $2a$10$ck/lKuJUD.ovPw0e3.lAnuuOMdviKPBujs4uMOpZSBWSBpOLKRGea
        String srcPwd = "www.alisls.com-pc-password";
        String encrypt = encrypt(srcPwd);
